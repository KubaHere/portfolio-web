  ...
  return (
    <section id="hero" className="hero" ref={heroRef}>
      <div className="hero__container">
        <div className={`hero__content ${isHeroVisible ? 'hero__content--visible' : ''}`}>
          <div className="hero__greeting">
            <span className="hero__greeting-text">{t('hero.hi')}</span>
          </div>
        ...
        <div className={`hero__scroll-indicator ${isHeroVisible ? 'hero__scroll-indicator--visible' : ''}`}>
